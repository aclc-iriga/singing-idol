...
$routes = [
    [ "name" => "Tabulation"      , "route" => "/singing-idol"         ],
    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 100vh;" >
        <div>
            <div class="text-center mb-5" >
                ...
                <h1 class="fw-bold" >singing-idol</h1>
                <p class="fst-italic" >Alinsangan Singing Idol (Nabua, Camarines Sur)</p>
            </div>
